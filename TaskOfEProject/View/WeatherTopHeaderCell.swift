...
class WeatherTopHeaderCell: DatasourceCell {
    ...
    override var datasourceItem: Any? {
        didSet {
            guard let weatherOverview = datasourceItem as? WeatherInfo else {
                return
            }
            cityNameTextView.text = weatherOverview.timezone
            temperatureLabel.text = "\(weatherOverview.currently.temperature)"
            todayLabel.text = "\(weatherOverview.currently.summary)"
            temperatureLowLabel.text =  "\(weatherOverview.currently.temperature)"
            temperatureHighLabel.text = "\(weatherOverview.currently.temperature)"
        }
    }
